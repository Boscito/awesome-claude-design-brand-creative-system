# Nike-Inspired Performance Creative System
...
| Token | Hex | Role |
|---|---|---|
| `--color-black` | `#050505` | Primary canvas and type |
| `--color-white` | `#ffffff` | Contrast field and type |
| `--color-stone` | `#e7e4df` | Warm neutral support |
| `--color-signal` | `#f15a24` | Rare campaign accent |
| `--color-steel` | `#6f7378` | Secondary text and utility |

### Color Behavior
Default to black, white, and photographic color. Use accent color sparingly for urgency, launch moments, and CTA focus.
...
### Recommended Fonts
Use a bold condensed grotesk for display and a clean sans for body. Avoid delicate serif display type.

### Hierarchy

| Level | Usage | Behavior |
|---|---|---|
| Display | Campaign headlines | Uppercase, heavy, large, tight line breaks |
| H1-H3 | Product and section headings | Bold, compressed, direct |
| Body | Product detail and support | Short sentences, high clarity |
| Caption | Athlete, product, material notes | Small, utilitarian, uppercase optional |
...
### Cards
Product cards should be image-led. Avoid decorative shadows. Use clean price/name metadata.

### Navigation
Minimal, high contrast, direct. Keep labels short.

### Forms & Inputs
Functional and quiet. Do not let forms soften the campaign energy.
...
### Subject Matter
Athletes in motion, products in use, training environments, streets, courts, tracks, fields, gyms, close product details.

### Photography Style
High-contrast action, documentary sport, premium campaign studio, sharp product macro.

### Composition Rules
Prefer full-bleed frames, decisive crops, dynamic diagonal movement, and negative space for bold type.

### Lighting
Hard sunlight, stadium lighting, flash, dramatic studio, or directional shadows. Avoid flat stock-style lighting.

### Color Treatment
High contrast with controlled saturation. Skin, fabric, and product color should feel real and tactile.

### Product Imagery
Show product as equipment, not decoration. Include grip, fabric, sole, tread, fit, flex, sweat, impact, or scale.

### People Imagery
Expressions can be focused, strained, calm, or victorious. Avoid generic smiling lifestyle poses.

### Illustration / Iconography / Abstract Visuals
Use only when supporting motion, measurement, or training logic. Keep graphics minimal and sharp.
...
### Organic Social
Mix athlete moments, product drops, training snippets, and culture. Keep copy short.

### Carousels
Slide 1: iconic action or product. Slides 2-4: feature proof. Final slide: direct CTA.

### Stories / Reels / Shorts Thumbnails
Use vertical crops with face, body motion, or product occupying at least half the frame.
...
### Product Sections
Alternate action context with product detail. Use short proof points.

### Editorial Sections
Use athlete stories, training philosophy, and product development details.

### Conversion Sections
Keep shopping modules clean, direct, and fast.
...
### Interaction Rules
Hover states should feel sharp. Avoid floaty, soft, whimsical motion.
...
### Headline Style
Short imperatives, declarations, and identity statements.

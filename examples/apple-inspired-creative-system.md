# Apple-Inspired Product Creative System
...
| Token | Hex | Role |
|---|---|---|
| `--color-white` | `#fbfbfd` | Primary light canvas |
| `--color-black` | `#000000` | Premium contrast canvas |
| `--color-ink` | `#1d1d1f` | Primary text |
| `--color-muted` | `#6e6e73` | Secondary text |
| `--color-blue` | `#0071e3` | CTA and link accent |

### Color Behavior
Use color with restraint. Product color, display content, and photography should provide most visual interest.
...
### Recommended Fonts
Use a clean system sans. Prioritize legibility and hierarchy over decorative personality.

### Hierarchy

| Level | Usage | Behavior |
|---|---|---|
| Display | Product campaign statements | Large, centered, confident |
| H1-H3 | Feature sections | Simple and benefit-led |
| Body | Explanation | Short, polished, plain |
| Caption | Specs, legal, feature notes | Small, exact, restrained |
...
### Cards
Use clean product tiles and feature panels. Shadows should be subtle or absent.

### Navigation
Thin, calm, predictable, product-first.

### Forms & Inputs
Plain, clear, polished.
...
### Subject Matter
Product hero renders, macro material details, hands using product, creative work in context, device screens, product families, accessories.

### Photography Style
Premium studio, cinematic product, macro detail, controlled lifestyle.

### Composition Rules
Favor centered product moments, elegant symmetry, controlled depth, and generous negative space.

### Lighting
Soft studio light, luminous edge light, screen glow, subtle reflections, controlled shadows.

### Color Treatment
Clean neutrals, accurate product color, restrained saturation, polished contrast.

### Product Imagery
Product must be pristine, recognizable, and dimensional. Show material, thinness, screen quality, camera, or interaction.

### People Imagery
Use hands, creators, workspaces, and quiet human moments. Avoid generic business lifestyle imagery.

### Illustration / Iconography / Abstract Visuals
Use minimal icons and abstract visuals only to explain technology, privacy, performance, or ecosystem.
...
### Organic Social
Product tips, creator workflows, launch highlights, ecosystem use, accessibility, privacy, and craft.

### Carousels
Slide 1: product hero. Slides 2-4: features with macro or screen details. Final slide: product family or CTA.

### Stories / Reels / Shorts Thumbnails
Use product closeups, interaction moments, and legible benefit text in safe zones.
...
### Product Sections
Break features into simple, visually distinct chapters.

### Editorial Sections
Use creator stories, material craft, environmental responsibility, privacy, and performance narratives.

### Conversion Sections
Comparison, pricing, trade-in, financing, support, and ecosystem benefits should remain calm and clear.
...
### Interaction Rules
Use subtle fades, product reveals, scroll-tied transitions, and precise easing.
...
### Headline Style
Short, polished, benefit-led, occasionally iconic.
